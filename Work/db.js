...
const MEMBER_LIST = [
  ...
  { name: '俊麟', aliases: ['俊麟','郭課','俊麟課長','access'] },
  { name: '靜怡', aliases: ['靜怡', '林靜怡', '靜怡課長'] },
  { name: '宏明', aliases: ['宏明'] },
  { name: '威蓁', aliases: ['威蓁'] },
  { name: '瀞萱', aliases: ['瀞萱','Monica'] },
  { name: '培華', aliases: ['培華','PeiHua'] },
  { name: '廷毓', aliases: ['廷毓','Nick Chang廷毓','Nick'] },
  { name: '銀燦', aliases: ['銀燦', 'stanny5', '銀燦-stanny5', 'Stanny5'] },
  { name: '育淇', aliases: ['育淇', '預期'] },
  { name: '亭諭', aliases: ['亭諭'] },
  { name: '暉文', aliases: ['黃暉文'] },
  { name: '景斌', aliases: ['莊景斌 Benjamin','Benjamin','景斌','莊景斌'] }
];
